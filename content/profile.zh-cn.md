...
title: "概况"
layout: "page"
summary: "工业通信、协议系统、边缘网关与 Linux 工程实践相关概况"
robotsNoIndex: true
searchHidden: true
---
...
工作范围：设备接入、协议转换、边缘网关与工业软件工程实践。  
经验包括：Qt 上位机开发、MCU 通信与业务逻辑实现，以及 Linux 环境下的构建、部署与维护。  
相关方向：EMS、Linux 与电力协议系统。
...
- **方向**：工业通信 ｜ 协议转换 ｜ 边缘网关 ｜ 能源软件
- **协议**：Modbus RTU / TCP ｜ IEC-104 ｜ MQTT ｜ CAN
- **实现**：C / C++ ｜ Linux ｜ Docker / Podman ｜ Redis / PostgreSQL
- **基础**：Qt ｜ MCU / FreeRTOS ｜ 现场联调与诊断工具

## 代表工作

- [Modbus-Tools](https://github.com/mingyucheng692/Modbus-Tools)：公开开源的工业调试工具
- [博客](/zh-cn/blog/)：工业通信、稳定性、协议工具与问题复盘文章
