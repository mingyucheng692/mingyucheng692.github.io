...
- 储能 EMS 系统开发:电力协议网关、多源设备数据接入与协议解析
- Linux 应用开发:IPC、多线程并发、TCP/UDP 网络编程
- 工业协议:IEC-61850(GOOSE/MMS)、IEC-104、Modbus、CAN、MQTT
...
- [Modbus-Tools](https://github.com/mingyucheng692/Modbus-Tools):跨平台 Modbus 调试工具 — [文章](/zh-cn/blog/tech/modbus-tools-intro/) · [仓库](https://github.com/mingyucheng692/Modbus-Tools)
- 更多代码见 [GitHub](https://github.com/mingyucheng692)

## 联系

如需详细背景信息,可通过上方邮箱联系,将在附件中提供完整简历 PDF。
